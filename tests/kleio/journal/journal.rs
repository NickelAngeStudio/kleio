...
use olympus_kleio::journal::{ KJournal, KJournalEntrySeverity, KJOURNAL_BUFFER_MIN, KJOURNAL_BUFFER_MAX, KJournalEntry, KJournalListener, listener::KJournalListenerListError };
...
fn kjournal_listeners() {
    ...
    match j.remove_listener(&nl0){
        ...
        Err(err) => match err {
            olympus_kleio::journal::listener::KJournalListenerListError::ListenerNotFound => {},
    ...
    match j.add_listener(&nl0){
        ...
        Err(err) => match err {
            olympus_kleio::journal::listener::KJournalListenerListError::ListenerAlreadyExists => {},
            _ => panic!("Wrong error given!"),
        },
    }
